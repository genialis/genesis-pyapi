# -*- coding: utf-8 -*-
#
# genapi documentation build configuration file, created by
# sphinx-quickstart on Sun May  5 17:07:04 2013.
#
...
latex_documents = [
  ('index', 'genapi.tex', TITLE, AUTHOR, 'manual'),
]
...
texinfo_documents = [
  ('index', 'genapi', TITLE,
   AUTHOR, 'genapi', 'One line description of project.',
   'Miscellaneous'),
]
